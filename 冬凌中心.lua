...
CoreGui:SetCore("SendNotification", {
    Title = "L脚本的欢迎",
    Text = "欢迎"..game.Players.LocalPlayer.Name.."执行 L脚本",
    Duration = 5,
})
print("L脚本滴反挂机已经为你开好了 喵~")
...
local function HeartbeatUpdate()
	...
	FpsLabel.Text = (" L脚本
时间="..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
Start = tick()
Heartbeat:Connect(HeartbeatUpdate)
local OrionLib = loadstring(game:HttpGet(('https://pastebin.com/raw/1mPger1J')))()
local Window = OrionLib:MakeWindow({IntroText = "感谢"..game.Players.LocalPlayer.Name.."加载GUI",Name = "L脚本-NEO.UI-1.2.8", HidePremium = false, SaveConfig = true, ConfigFolder = "大哥这缝合脚本啊"})
...
local Tab = Window:MakeTab({
 ...
 Tab:AddButton({
	Name = "₪Krx(L脚本)〔推荐〕",
	Callback = function()
getgenv().LS="L脚本中心" loadstring(game:HttpGet("https://raw.githubusercontent.com/krlpl/Deciduous-center-LS/main/%E8%90%BD%E5%8F%B6%E4%B8%AD%E5%BF%83%E6%B7%B7%E6%B7%86.txt"))()
end
})
Tab:AddButton({
  Name = "飞行V3GUI",
